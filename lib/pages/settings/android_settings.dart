...
class _AndroidSettingsState extends State<AndroidSettings> {
  ...
  List<Widget> _buildAndroidWebViewTabSettings() {
    ...
    TextStyle warningStyle = TextStyle(color: Colors.red);
    ...
    var widgets = <Widget>[
      ListTile(
        title: RichText(
          text: TextSpan(
            style: warningStyle,
            children: [
              TextSpan(text: "Warning: Use at your own risk.", style: TextStyle(fontSize: 18))
            ]
          ),
        ),
        enabled: true,
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.clearSessionCache,
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.builtInZoomControls,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.displayZoomControls,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.databaseEnabled,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.domStorageEnabled,
        onChanged: (value) {
          setState(() {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.useWideViewPort,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.allowContentAccess,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.allowFileAccess,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.allowFileAccessFromFileURLs,
        onChanged: (value) async {
          currentWebViewModel.options.android.allowFileAccessFromFileURLs =
              value;
          _webViewController.setOptions(options: currentWebViewModel.options);
          currentWebViewModel.options = await _webViewController.getOptions();
          browserModel.save();
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel
            .options.android.allowUniversalAccessFromFileURLs,
        onChanged: (value) async {
          currentWebViewModel.options.android.allowUniversalAccessFromFileURLs =
              value;
          _webViewController.setOptions(options: currentWebViewModel.options);
          currentWebViewModel.options = await _webViewController.getOptions();
          browserModel.save();
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.blockNetworkImage,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.blockNetworkLoads,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.geolocationEnabled,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.loadWithOverviewMode,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.needInitialFocus,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.offscreenPreRaster,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.saveFormData,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.hardwareAcceleration,
        onChanged: (value) async {
      ...
      SwitchListTile(
        ...
        value: currentWebViewModel.options.android.scrollbarFadingEnabled,
        onChanged: (value) async {
