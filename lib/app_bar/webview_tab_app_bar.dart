...
class _WebViewTabAppBarState extends State<WebViewTabAppBar>
  ...
  Widget _buildAppBarHomePageWidget() {
    ...
    return IconButton(
      icon: Icon(Icons.home, size: 28, color: Color.fromRGBO(130, 130, 140, 1),),
      onPressed: () {
        ...
        children: <Widget>[
          TextField(
            onSubmitted: (value) {
              ...
              if (!value.startsWith("http") && !Util.isLocalizedContent(url)) {
            ...
            decoration: InputDecoration(
              contentPadding: const EdgeInsets.only(
                  left: 45.0, top: 9.0, right: 10.0, bottom: 11.0),
              filled: true,
                  ...
                  items: TabPopupMenuActions.choices.map((tabPopupMenuAction) {
                    ...
                    switch (tabPopupMenuAction) {
                      ...
                      case TabPopupMenuActions.NEW_INCOGNITO_TAB:
                        iconData = FlutterIcons.incognito_mco;
                        break;
                    }
